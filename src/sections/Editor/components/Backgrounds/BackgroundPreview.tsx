...
export default function BackgroundPreview({
  ...
  return (
    <div
      className={`z-10 group aspect-square w-full rounded-2xl relative hover:opacity-80 hover:cursor-pointer transition-opacity mb-4 ${active ? 'border-4 border-pink-gradient shadow-xl' : ''}`}
    >
      <CldImage
      onClick={onClick}
      src={base}
