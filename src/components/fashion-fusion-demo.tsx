          ...
          <div className="flex items-center p-12">
            <div className="w-1/2">
              ...
              <p className="text-xl mb-6 text-white">
                Try on the latest styles without leaving your home!
              </p>
              <Button
                size="lg"
              ...
              <Tabs defaultValue="outfits" className="w-full">
                ...
                <TabsContent value="outfits">
                  <div className="grid grid-cols-3 gap-4 mt-6">
                    {[
                      ...
                      <Card
                        key={item}
                        className={`cursor-pointer transition-all ${selectedOutfit === item.toLowerCase() ? 'ring-2 ring-purple-500' : ''}`}
                        onClick={() => handleOutfitChange(item.toLowerCase())}
                      >
                ...
                <TabsContent value="upload">
                  <div className="mt-6">
                    ...
                    <p className="mb-4">
                      To get the most accurate virtual try-on experience, upload
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  'Browse our extensive collection of virtual clothes.',
              },
              {
                title: 'See the Magic',
                description:
                  'Our AI will show you wearing the selected outfit!',
              },
            ].map((step, index) => (
              <Card key={index}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Experience the future of fashion with our virtual try-on
                technology.
              </p>
            </div>
            <div>
